...
function ISFurnaceInfoWindow:setObject(object)
	...
	self.panel.description = getText("IGUI_Generator_FuelAmount", luautils.round(self.fuel,2)) .. " <LINE> " .. getText("IGUI_FireStarted") .. ": " .. self.fireStarted .. " <LINE> " .. getText("IGUI_Heat") .. ": " .. luautils.round(self.heat,2) .. "%";
